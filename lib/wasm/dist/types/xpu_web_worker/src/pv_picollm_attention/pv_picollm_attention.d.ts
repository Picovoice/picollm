...
export declare const getPicollmAttentionWasmFunctions: (memory: WebAssembly.Memory, graph: PvGraph, imports?: any) => {
    pv_picollm_attention_precompute_encoding_web_worker_wasm: (objAddress: number, encodingAddress: number, dimension: number, steps: number, theta: number, ropeScalesAddress: number, ropeScale: number, statusAddress: number) => Promise<void>;
